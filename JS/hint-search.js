...
class Autocomplete {
  ...
  createItem(lookup, item) {
    ...
    return ce(
      `<button type="button" style = "font-size: 11.3px; color: #707070; letter-spacing: 0.5px;"class="dropdown-item py-2" data-label="${item.label}" data-value="${item.value}">${label}</button>`
    );
  }
